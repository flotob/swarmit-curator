...
export async function pollOnce() {
  ...
  // Publish board/thread indexes — liveness sweeps run on their own schedule
  // (see startLivenessScheduler) and post pruned boards into republish_boards,
  // which is unioned in below.
